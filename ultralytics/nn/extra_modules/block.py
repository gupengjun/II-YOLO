...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C3k2_Faster', 'C3k2_ODConv', 'Partial_conv3', 'C3k2_Faster_EMA', 'C3k2_DBB',
           ...
           'C3k2_MBRConv3', 'C3k2_VSSD', 'C3k2_TVIM', 'DPCF', 'C3k2_CSI', 'C3k2_SHSA_EPGO', 'C3k2_SHSA_EPGO_CGLU', 'C3k2_ConvAttn', 'C3k2_UniConvBlock', 'C3k2_LGLB', 'C3k2_ConverseB', 'C3k2_Converse'
           ]
...
class Zoom_cat(nn.Module):
    ...
    def forward(self, x):
        ...
        tgt_size = m.shape[2:]
#===========================
        stride_h = l.shape[2] // tgt_size[0]
        stride_w = l.shape[3] // tgt_size[1]
	# 使用 3×3 卷积进行下采样（无 BN、无激活）
        weight = torch.ones((l.shape[1], 1, 3, 3), device=l.device, dtype=l.dtype) / 9.0
        l = F.conv2d(l, weight, stride=(stride_h, stride_w), padding=1, groups=l.shape[1])
#===========================
